...
int main(int argc, char *argv[]) {
	...
	// Add without rythm, and you won't attract a worm.
	PicInfo *list = NULL;
	PicInfoAddToList(&list, ref_1);
	PicInfoAddToList(&list, ref_0);
	PicInfoAddToList(&list, ref_4);
	PicInfoAddToList(&list, ref_3);
	PicInfoAddToList(&list, ref_2);
	...
	printf("End test. No errors means tests passed.\n");
	exit(0);
}
